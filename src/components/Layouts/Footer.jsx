...
export default function Footer() {
	return (
		<footer 
			className="w-screen bg-[var(--peachPuff)] border-t-4 border-t-[var(--blackCustom)] pt-8 md:pt-4 text-sm dark:bg-[#CC9F02] dark:text-gray-100 dark:border-t-[#870446]" 
			aria-labelledby="footer"
			aria-describedby="footerDescription"
		>
			<div className="max-w-7xl mx-auto px-6 flex justify-between items-center ">
				<div className="flex flex-wrap justify-between items-start md:items-center w-full ">
					{/* Logo and Description */}
					<div className="w-[230px] mx-auto md:mx-0 p-2 md:order-1 overflow-clip order-3 ">
						<img
							...
							height="100%"
							className="shadow-custom leading-loose"
							aria-label="Diyah Gift Logo"
						/>
					</div>

					{/* Navigation Links */}
					<div className="w-1/2 md:w-1/4 mb-8 md:mb-0 md:order-2 order-1">
						<h3 className="font-light text-gray-900 mb-4 dark:text-[#D8D8D8]" id="footerMenu">Menu</h3>
						<ul className="space-y-3" aria-labelledby="footerMenu">
							<li>
								<a href="/" className="text-gray-600 dark:text-[#D8D8D8] hover:text-rose-500" aria-label="Navigate to home page">
									Beranda
								</a>
							</li>
							<li>
					...
					{/* Social Media Links */}
					<div className="w-1/2 md:w-1/3 md:order-3 order-2">
						<h3 className="font-light text-gray-900 mb-4 dark:text-[#D8D8D8]" id="footerFollowUs">Ikuti Kami</h3>
						<ul className="space-y-3" aria-labelledby="footerFollowUs">
							<li>
								<a
									href="https://wa.me/6285342181132"
									target="_blank"
			...
			{/* Copyright */}
			<div className="mt-3 pb-24 pt-4 md:pt-4 md:pb-4 md:order-4 order-3 w-screen bg-[var(--blackCustom)]" id="footerDescription">
