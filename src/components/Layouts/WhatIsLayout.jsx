...
const WhatIsLayout = () => {
	return (
		<div className="flex flex-col md:flex-row md:gap-10 w-full justify-between">
			...
			<div className="hidden md:w-1/2 md:flex justify-between flex-row gap-2 md:gap-5 bg-slate-400 p-1 md:p-5 order-1 md:order-0">
				<div className="w-1/2 bg-slate-900">
					<img src="" width="100%" height="100%" alt="Profile Selempang" />
				</div>
				<div className='bg-slate-900 w-1/2  '><img src="" width=" 100%" height="100%" alt="Profile Buket" /></div>
