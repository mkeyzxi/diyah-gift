...
const IntroLayout = ({ textOne, textTwo }) => {
	return (
		<div
			className="max-w-full min-h-screen bg-[url(../image/BerandaBackground.png)] bg-cover flex flex-col justify-center items-center gap-2 text-[var(--pink)] font-semibold text-7xl lg:text-[263px] lg:gap-0 border-b-5 border-b-[var(--yellow)]"
			role="banner"
		...
		>
			...
			<h1
				id="introDescription"
				className="text-6xl relative z-2 lg:text-[227px]"
