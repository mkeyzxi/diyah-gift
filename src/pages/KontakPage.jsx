...
// 			<div>
// 			{/* <HeaderNavLayout  /> */}
// 				<HeaderNavLayout headerTitle={
// 						<>
// 							Menampilkan <span className={titleHeaderState === "Whatsapp" ? "text-green-400" : "text-red-500"}>{titleHeaderState}</span>
// 						</>
// 					}>
					

// 					<span
// 						className={`text-[var(--pinkSecondary)] cursor-pointer ${titleHeaderState === 'Whatsapp' ? '!text-green-400' : 'text-red-500'
// 							}`}
...
// 					</span>
// 					<span
// 						className={`text-[var(--pinkSecondary)] cursor-pointer ${titleHeaderState === 'Email' ? '!text-green-400' : ''
// 							}`}
